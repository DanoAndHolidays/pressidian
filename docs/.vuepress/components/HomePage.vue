...
<style scoped>
*{box-sizing:border-box}.garden-home{--canvas:#f7f2e8;--paper:#fffaf0;--ink:#26352b;--forest:#2e5943;--forest-soft:#416d55;--orange:#e7793f;--orange-dark:#be5730;--orange-pale:#f1d3bd;--sage:#dce4cf;--line:#d8d0bf;--muted:#737b70;min-height:100vh;background:var(--canvas);color:var(--ink);font-family:"Avenir Next",Inter,"PingFang SC","Microsoft YaHei",sans-serif;background-image:radial-gradient(color-mix(in srgb,var(--muted) 35%,transparent) .6px,transparent .6px);background-size:17px 17px;transition:background .25s,color .25s}.garden-home.is-dark{--canvas:#101914;--paper:#17231c;--ink:#f3eddf;--forest:#244b38;--forest-soft:#315b45;--orange:#f08a50;--orange-dark:#ffc09b;--orange-pale:#573726;--sage:#26382c;--line:#34483a;--muted:#a2aa9d}.garden-shell{width:min(100% - 52px,1340px);margin:auto}.garden-nav{height:92px;display:flex;align-items:center;gap:42px}.garden-brand{display:flex;align-items:center;gap:10px;color:var(--forest);font:600 25px Georgia,"Songti SC",serif;text-decoration:none}.is-dark .garden-brand{color:var(--orange)}.fox-mark{width:31px;height:31px;fill:var(--orange)}.fox-mark-face{fill:var(--paper)}.fox-mark-eye{fill:var(--ink)}.garden-links{display:flex;gap:25px}.garden-links a{color:var(--ink);font-size:13px;text-decoration:none;padding:8px 0;border-bottom:1px solid transparent}.garden-links a:hover,.garden-links a.router-link-active{color:var(--orange);border-color:var(--orange)}.garden-actions{margin-left:auto;display:flex;gap:9px}.theme-toggle,.search-button{width:39px;height:39px;border:1px solid var(--line);border-radius:99px;background:color-mix(in srgb,var(--paper) 75%,transparent);color:var(--ink);display:grid;place-items:center;cursor:pointer}.search-button svg{width:16px}.theme-toggle:hover,.search-button:hover{border-color:var(--orange);color:var(--orange)}.menu-toggle{display:none}
.hero-section{position:relative;min-height:525px;background:var(--forest);color:#fffaf0;border-radius:26px 26px 105px 26px;overflow:hidden;padding:66px 52px;display:grid;grid-template-columns:1.23fr .77fr;gap:38px}.hero-section:after{content:"";position:absolute;width:190px;height:190px;right:-45px;bottom:-75px;background:var(--orange);border-radius:63% 37% 28% 72% / 58% 32% 68% 42%;opacity:.55;transform:rotate(-20deg)}.eyebrow{font-size:10px;letter-spacing:.15em;color:#d2ddce;margin:0}.hero-copy h1{font:400 clamp(55px,6.8vw,96px)/.98 Georgia,"Songti SC",serif;letter-spacing:-.055em;margin:22px 0}.hero-copy h1 span{color:#ff9a61;font-style:italic}.hero-intro{max-width:600px;color:#d8e1d5;line-height:1.8;font-size:15px;margin:0}.hero-actions{display:flex;align-items:center;gap:22px;margin-top:28px}.primary-button{display:inline-flex;align-items:center;gap:13px;color:#2d261f;background:#ff9a61;border-radius:99px;padding:13px 18px;text-decoration:none;font-size:13px;font-weight:650}.primary-button:hover{background:#ffb083;transform:translateY(-2px)}.text-button{color:#e6ede3;text-decoration:none;font-size:12px;border-bottom:1px solid #8ba08f;padding-bottom:3px}.knowledge-map{position:relative;min-height:370px}.map-lines{position:absolute;inset:0;width:100%;height:100%;color:#809886}.map-node{position:absolute;background:#fffaf0;color:var(--forest);border-radius:50%;display:grid;place-items:center;text-align:center;text-decoration:none;box-shadow:0 10px 28px rgba(8,28,17,.16);font:12px/1.2 Georgia,"Songti SC",serif;transition:transform .2s}.map-node small{display:block;font:8px "Avenir Next",sans-serif;color:var(--orange)}.map-node:hover{transform:translateY(-4px) rotate(2deg)}.node-project{width:76px;height:76px;left:2%;top:8%}.node-notes{width:83px;height:83px;right:0;top:6%}.node-lab{width:67px;height:67px;left:3%;bottom:6%}.node-about{width:72px;height:72px;right:5%;bottom:4%}.fox-node{position:absolute;width:126px;height:126px;left:35%;top:31%;border-radius:50%;background:#fffaf0;display:grid;place-items:center;text-decoration:none;box-shadow:0 13px 36px rgba(8,28,17,.2)}.fox-node svg{position:absolute;width:82px;height:82px;top:9px}.fox-ear{fill:var(--orange)}.fox-cheek{fill:#fff3df}.fox-detail{fill:#26352b}.fox-node span{position:absolute;bottom:9px;color:var(--forest);font:8px/1.2 "Avenir Next",sans-serif;text-align:center;text-transform:uppercase;letter-spacing:.06em}.fox-tail{position:absolute;right:3%;top:43%;width:47px;height:88px;background:var(--orange);border-radius:70% 30% 70% 30%;transform:rotate(28deg);opacity:.8}.fox-tail:after{content:"";position:absolute;right:0;bottom:0;width:25px;height:28px;background:#fff3df;border-radius:0 0 80% 20%}
