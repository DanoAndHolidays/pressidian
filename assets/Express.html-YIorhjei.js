import{_ as n,c as e,b as a,o as i}from"./app-BWIZ-jfc.js";const l={};function d(p,s){return i(),e("div",null,[...s[0]||(s[0]=[a(`<p>封装了Node.js的API，简化了搭建后端的操作流程</p><h4 id="初始化" tabindex="-1"><a class="header-anchor" href="#初始化"><span>初始化</span></a></h4><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">npm init //创建package.json文件</span>
