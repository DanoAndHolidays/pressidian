import{_ as n,c as e,b as a,o as i}from"./app-NOeoeEVV.js";const t={};function d(l,s){return i(),e("div",null,[...s[0]||(s[0]=[a(`<h1 id="monorepo-设计分析" tabindex="-1"><a class="header-anchor" href="#monorepo-设计分析"><span>Monorepo 设计分析</span></a></h1><p>本文档剖析本项目的 Monorepo 架构设计，并沉淀可复用的设计方法论。</p><hr><h2 id="项目全景" tabindex="-1"><a class="header-anchor" href="#项目全景"><span>项目全景</span></a></h2><h3 id="_1-目录结构" tabindex="-1"><a class="header-anchor" href="#_1-目录结构"><span>1. 目录结构</span></a></h3><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code class="language-text"><span class="line">daedalus/</span>
