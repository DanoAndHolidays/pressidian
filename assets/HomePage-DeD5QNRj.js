import{c as sa,d as aa,u as Al,a as Rl,r as Xn,o as Lo,b as Do,e as yn,w as ms,f as gi,g as Wt,h as ie,i as rt,t as Ye,F as It,j as en,k as yr,n as Io,l as Ve,m as wl,p as gs,q as Xe,_ as oa,s as Cl,v as Pl,x as Ll,S as La,y as Lt,z as ft,P as Yi,A as Ki,R as $t,B as ti,C as Dl,D as Da,G as Il,E as ni,H as Ul,I as Nl,J as Fl,K as Ol,N as Bl}from"./index-B-gtufcj.js";import{F as zl}from"./FoxMark-mTRlap9n.js";import{S as Gl}from"./sparkles-EDDXqBgo.js";/**
...
}`;class hm{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ol(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Ht({vertexShader:dm,fragmentShader:fm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Kt(new Wi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class pm extends Qn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,p=null,f=null,u=null,h=null,x=null;const M=typeof XRWebGLBinding<"u",g=new hm,d={},T=t.getContextAttributes();let C=null,S=null;const E=[],y=[],R=new Ke;let _=null,A=null;const D=new tn;D.viewport=new ht;const N=new tn;N.viewport=new ht;const B=[D,N],k=new Mu;let I=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let j=E[Y];return j===void 0&&(j=new Kr,E[Y]=j),j.getTargetRaySpace()},this.getControllerGrip=function(Y){let j=E[Y];return j===void 0&&(j=new Kr,E[Y]=j),j.getGripSpace()},this.getHand=function(Y){let j=E[Y];return j===void 0&&(j=new Kr,E[Y]=j),j.getHandSpace()};function $(Y){const j=y.indexOf(Y.inputSource);if(j===-1)return;const ve=E[j];ve!==void 0&&(ve.update(Y.inputSource,Y.frame,l||a),ve.dispatchEvent({type:Y.type,data:Y.inputSource}))}function W(){r.removeEventListener("select",$),r.removeEventListener("selectstart",$),r.removeEventListener("selectend",$),r.removeEventListener("squeeze",$),r.removeEventListener("squeezestart",$),r.removeEventListener("squeezeend",$),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",ne);for(let Y=0;Y<E.length;Y++){const j=y[Y];j!==null&&(y[Y]=null,E[Y].disconnect(j))}I=null,H=null,g.reset();for(const Y in d)delete d[Y];if(e.setRenderTarget(C),h=null,u=null,f=null,r=null,S=null,Ge.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(R.width,R.height,!1),A!==null){const Y=A.camera;Y.fov=A.fov,Y.zoom=A.zoom,Y.updateProjectionMatrix(),A=null}n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,n.isPresenting===!0&&De("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){o=Y,n.isPresenting===!0&&De("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Y){l=Y},this.getBaseLayer=function(){return u!==null?u:h},this.getBinding=function(){return f===null&&M&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(C=e.getRenderTarget(),r.addEventListener("select",$),r.addEventListener("selectstart",$),r.addEventListener("selectend",$),r.addEventListener("squeeze",$),r.addEventListener("squeezestart",$),r.addEventListener("squeezeend",$),r.addEventListener("end",W),r.addEventListener("inputsourceschange",ne),T.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(R),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let ve=null,Te=null,ge=null;T.depth&&(ge=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ve=T.stencil?Yn:Rn,Te=T.stencil?zi:gn);const Ce={colorFormat:t.RGBA8,depthFormat:ge,scaleFactor:s};f=this.getBinding(),u=f.createProjectionLayer(Ce),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),S=new Yt(u.textureWidth,u.textureHeight,{format:rn,type:qt,depthTexture:new Gi(u.textureWidth,u.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,ve),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1,storeMultisampledDepthBuffer:u.ignoreDepthValues===!1,storeMultisampledStencilBuffer:u.ignoreDepthValues===!1})}else{const ve={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,t,ve),r.updateRenderState({baseLayer:h}),e.setPixelRatio(1),e.setSize(h.framebufferWidth,h.framebufferHeight,!1),S=new Yt(h.framebufferWidth,h.framebufferHeight,{format:rn,type:qt,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1,storeMultisampledDepthBuffer:h.ignoreDepthValues===!1,storeMultisampledStencilBuffer:h.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Ge.setContext(r),Ge.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function ne(Y){for(let j=0;j<Y.removed.length;j++){const ve=Y.removed[j],Te=y.indexOf(ve);Te>=0&&(y[Te]=null,E[Te].disconnect(ve))}for(let j=0;j<Y.added.length;j++){const ve=Y.added[j];let Te=y.indexOf(ve);if(Te===-1){for(let Ce=0;Ce<E.length;Ce++)if(Ce>=y.length){y.push(ve),Te=Ce;break}else if(y[Ce]===null){y[Ce]=ve,Te=Ce;break}if(Te===-1)break}const ge=E[Te];ge&&ge.connect(ve)}}const X=new G,ee=new G;function q(Y,j,ve){X.setFromMatrixPosition(j.matrixWorld),ee.setFromMatrixPosition(ve.matrixWorld);const Te=X.distanceTo(ee),ge=j.projectionMatrix.elements,Ce=ve.projectionMatrix.elements,nt=ge[14]/(ge[10]-1),Be=ge[14]/(ge[10]+1),Ze=(ge[9]+1)/ge[5],at=(ge[9]-1)/ge[5],He=(ge[8]-1)/ge[0],ut=(Ce[8]+1)/Ce[0],Et=nt*He,Nt=nt*ut,dt=Te/(-He+ut),gt=dt*-He;if(j.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(gt),Y.translateZ(dt),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),ge[10]===-1)Y.projectionMatrix.copy(j.projectionMatrix),Y.projectionMatrixInverse.copy(j.projectionMatrixInverse);else{const L=nt+dt,Tt=Be+dt,et=Et-gt,b=Nt+(Te-gt),m=Ze*Be/Tt*L,U=at*Be/Tt*L;Y.projectionMatrix.makePerspective(et,b,m,U,L,Tt),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function se(Y,j){j===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(j.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let j=Y.near,ve=Y.far;g.texture!==null&&(g.depthNear>0&&(j=g.depthNear),g.depthFar>0&&(ve=g.depthFar)),k.near=N.near=D.near=j,k.far=N.far=D.far=ve,(I!==k.near||H!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),I=k.near,H=k.far),k.layers.mask=Y.layers.mask|6,D.layers.mask=k.layers.mask&-5,N.layers.mask=k.layers.mask&-3;const Te=Y.parent,ge=k.cameras;se(k,Te);for(let Ce=0;Ce<ge.length;Ce++)se(ge[Ce],Te);ge.length===2?q(k,D,N):k.projectionMatrix.copy(D.projectionMatrix),A===null&&Y.isPerspectiveCamera&&(A={camera:Y,fov:Y.fov,zoom:Y.zoom}),ae(Y,k,Te)};function ae(Y,j,ve){ve===null?Y.matrix.copy(j.matrixWorld):(Y.matrix.copy(ve.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(j.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(j.projectionMatrix),Y.projectionMatrixInverse.copy(j.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=na*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(u===null&&h===null))return c},this.setFoveation=function(Y){c=Y,u!==null&&(u.fixedFoveation=Y),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=Y)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(k)},this.getCameraTexture=function(Y){return d[Y]};let Ne=null;function Pe(Y,j){if(p=j.getViewerPose(l||a),x=j,p!==null){const ve=p.views;h!==null&&(e.setRenderTargetFramebuffer(S,h.framebuffer),e.setRenderTarget(S));let Te=!1;ve.length!==k.cameras.length&&(k.cameras.length=0,Te=!0);for(let Be=0;Be<ve.length;Be++){const Ze=ve[Be];let at=null;if(h!==null)at=h.getViewport(Ze);else{const ut=f.getViewSubImage(u,Ze);at=ut.viewport,Be===0&&(e.setRenderTargetTextures(S,ut.colorTexture,ut.depthStencilTexture),e.setRenderTarget(S))}let He=B[Be];He===void 0&&(He=new tn,He.layers.enable(Be),He.viewport=new ht,B[Be]=He),He.matrix.fromArray(Ze.transform.matrix),He.matrix.decompose(He.position,He.quaternion,He.scale),He.projectionMatrix.fromArray(Ze.projectionMatrix),He.projectionMatrixInverse.copy(He.projectionMatrix).invert(),He.viewport.set(at.x,at.y,at.width,at.height),Be===0&&(k.matrix.copy(He.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),Te===!0&&k.cameras.push(He)}const ge=r.enabledFeatures;if(ge&&ge.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&M){f=n.getBinding();const Be=f.getDepthInformation(ve[0]);Be&&Be.isValid&&Be.texture&&g.init(Be,r.renderState)}if(ge&&ge.includes("camera-access")&&M){e.state.unbindTexture(),f=n.getBinding();for(let Be=0;Be<ve.length;Be++){const Ze=ve[Be].camera;if(Ze){let at=d[Ze];at||(at=new ol,d[Ze]=at);const He=f.getCameraImage(Ze);at.sourceTexture=He}}}}for(let ve=0;ve<E.length;ve++){const Te=y[ve],ge=E[ve];Te!==null&&ge!==void 0&&ge.update(Te,j,l||a)}Ne&&Ne(Y,j),j.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:j}),x=null}const Ge=new dl;Ge.setAnimationLoop(Pe),this.setAnimationLoop=function(Y){Ne=Y},this.dispose=function(){}}}const mm=new mt,vl=new Ie;vl.set(-1,0,0,0,1,0,0,0,1);function gm(i,e){function t(g,d){g.matrixAutoUpdate===!0&&g.updateMatrix(),d.value.copy(g.matrix)}function n(g,d){d.color.getRGB(g.fogColor.value,ll(i)),d.isFog?(g.fogNear.value=d.near,g.fogFar.value=d.far):d.isFogExp2&&(g.fogDensity.value=d.density)}function r(g,d,T,C,S){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(g,d):d.isMeshLambertMaterial?(s(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(g,d),f(g,d)):d.isMeshPhongMaterial?(s(g,d),p(g,d),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(g,d),u(g,d),d.isMeshPhysicalMaterial&&h(g,d,S)):d.isMeshMatcapMaterial?(s(g,d),x(g,d)):d.isMeshDepthMaterial?s(g,d):d.isMeshDistanceMaterial?(s(g,d),M(g,d)):d.isMeshNormalMaterial?s(g,d):d.isLineBasicMaterial?(a(g,d),d.isLineDashedMaterial&&o(g,d)):d.isPointsMaterial?c(g,d,T,C):d.isSpriteMaterial?l(g,d):d.isShadowMaterial?(g.color.value.copy(d.color),g.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(g,d){g.opacity.value=d.opacity,d.color&&g.diffuse.value.copy(d.color),d.emissive&&g.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.bumpMap&&(g.bumpMap.value=d.bumpMap,t(d.bumpMap,g.bumpMapTransform),g.bumpScale.value=d.bumpScale,d.side===Ot&&(g.bumpScale.value*=-1)),d.normalMap&&(g.normalMap.value=d.normalMap,t(d.normalMap,g.normalMapTransform),g.normalScale.value.copy(d.normalScale),d.side===Ot&&g.normalScale.value.negate()),d.displacementMap&&(g.displacementMap.value=d.displacementMap,t(d.displacementMap,g.displacementMapTransform),g.displacementScale.value=d.displacementScale,g.displacementBias.value=d.displacementBias),d.emissiveMap&&(g.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,g.emissiveMapTransform)),d.specularMap&&(g.specularMap.value=d.specularMap,t(d.specularMap,g.specularMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest);const T=e.get(d),C=T.envMap,S=T.envMapRotation;C&&(g.envMap.value=C,g.envMapRotation.value.setFromMatrix4(mm.makeRotationFromEuler(S)).transpose(),C.isCubeTexture&&C.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(vl),g.reflectivity.value=d.reflectivity,g.ior.value=d.ior,g.refractionRatio.value=d.refractionRatio),d.lightMap&&(g.lightMap.value=d.lightMap,g.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,g.lightMapTransform)),d.aoMap&&(g.aoMap.value=d.aoMap,g.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,g.aoMapTransform))}function a(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform))}function o(g,d){g.dashSize.value=d.dashSize,g.totalSize.value=d.dashSize+d.gapSize,g.scale.value=d.scale}function c(g,d,T,C){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.size.value=d.size*T,g.scale.value=C*.5,d.map&&(g.map.value=d.map,t(d.map,g.uvTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function l(g,d){g.diffuse.value.copy(d.color),g.opacity.value=d.opacity,g.rotation.value=d.rotation,d.map&&(g.map.value=d.map,t(d.map,g.mapTransform)),d.alphaMap&&(g.alphaMap.value=d.alphaMap,t(d.alphaMap,g.alphaMapTransform)),d.alphaTest>0&&(g.alphaTest.value=d.alphaTest)}function p(g,d){g.specular.value.copy(d.specular),g.shininess.value=Math.max(d.shininess,1e-4)}function f(g,d){d.gradientMap&&(g.gradientMap.value=d.gradientMap)}function u(g,d){g.metalness.value=d.metalness,d.metalnessMap&&(g.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,g.metalnessMapTransform)),g.roughness.value=d.roughness,d.roughnessMap&&(g.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,g.roughnessMapTransform)),d.envMap&&(g.envMapIntensity.value=d.envMapIntensity)}function h(g,d,T){g.ior.value=d.ior,d.sheen>0&&(g.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),g.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(g.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,g.sheenColorMapTransform)),d.sheenRoughnessMap&&(g.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,g.sheenRoughnessMapTransform))),d.clearcoat>0&&(g.clearcoat.value=d.clearcoat,g.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(g.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,g.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(g.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ot&&g.clearcoatNormalScale.value.negate())),d.dispersion>0&&(g.dispersion.value=d.dispersion),d.retroreflectivity>0&&(g.retroreflectivity.value=d.retroreflectivity),d.iridescence>0&&(g.iridescence.value=d.iridescence,g.iridescenceIOR.value=d.iridescenceIOR,g.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(g.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,g.iridescenceMapTransform)),d.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),d.transmission>0&&(g.transmission.value=d.transmission,g.transmissionSamplerMap.value=T.texture,g.transmissionSamplerSize.value.set(T.width,T.height),d.transmissionMap&&(g.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,g.transmissionMapTransform)),g.thickness.value=d.thickness,d.thicknessMap&&(g.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=d.attenuationDistance,g.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(g.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(g.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=d.specularIntensity,g.specularColor.value.copy(d.specularColor),d.specularColorMap&&(g.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,g.specularColorMapTransform)),d.specularIntensityMap&&(g.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,g.specularIntensityMapTransform))}function x(g,d){d.matcap&&(g.matcap.value=d.matcap)}function M(g,d){const T=e.get(d).light;g.referencePosition.value.setFromMatrixPosition(T.matrixWorld),g.nearDistance.value=T.shadow.camera.near,g.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function _m(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(S,E){const y=E.program;n.uniformBlockBinding(S,y)}function l(S,E){let y=r[S.id];y===void 0&&(g(S),y=p(S),r[S.id]=y,S.addEventListener("dispose",T));const R=E.program;n.updateUBOMapping(S,R);const _=e.render.frame;s[S.id]!==_&&(u(S),s[S.id]=_)}function p(S){const E=f();S.__bindingPointIndex=E;const y=i.createBuffer(),R=S.__size,_=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,R,_),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,y),y}function f(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return $e("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){const E=r[S.id],y=S.uniforms,R=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let _=0,A=y.length;_<A;_++){const D=y[_];if(Array.isArray(D))for(let N=0,B=D.length;N<B;N++)h(D[N],_,N,R);else h(D,_,0,R)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function h(S,E,y,R){if(M(S,E,y,R)===!0){const _=S.__offset,A=S.value;if(Array.isArray(A)){let D=0;for(let N=0;N<A.length;N++){const B=A[N],k=d(B);x(B,S.__data,D),typeof B!="number"&&typeof B!="boolean"&&!B.isMatrix3&&!ArrayBuffer.isView(B)&&(D+=k.storage/Float32Array.BYTES_PER_ELEMENT)}}else x(A,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,_,S.__data)}}function x(S,E,y){typeof S=="number"||typeof S=="boolean"?E[0]=S:S.isMatrix3?(E[0]=S.elements[0],E[1]=S.elements[1],E[2]=S.elements[2],E[3]=0,E[4]=S.elements[3],E[5]=S.elements[4],E[6]=S.elements[5],E[7]=0,E[8]=S.elements[6],E[9]=S.elements[7],E[10]=S.elements[8],E[11]=0):ArrayBuffer.isView(S)?E.set(new S.constructor(S.buffer,S.byteOffset,E.length)):S.toArray(E,y)}function M(S,E,y,R){const _=S.value,A=E+"_"+y;if(R[A]===void 0)return typeof _=="number"||typeof _=="boolean"?R[A]=_:ArrayBuffer.isView(_)?R[A]=_.slice():R[A]=_.clone(),!0;{const D=R[A];if(typeof _=="number"||typeof _=="boolean"){if(D!==_)return R[A]=_,!0}else{if(ArrayBuffer.isView(_))return!0;if(D.equals(_)===!1)return D.copy(_),!0}}return!1}function g(S){const E=S.uniforms;let y=0;const R=16;for(let A=0,D=E.length;A<D;A++){const N=Array.isArray(E[A])?E[A]:[E[A]];for(let B=0,k=N.length;B<k;B++){const I=N[B],H=Array.isArray(I.value)?I.value:[I.value];for(let $=0,W=H.length;$<W;$++){const ne=H[$],X=d(ne),ee=y%R,q=ee%X.boundary,se=ee+q;y+=q,se!==0&&R-se<X.storage&&(y+=R-se),I.__data=new Float32Array(X.storage/Float32Array.BYTES_PER_ELEMENT),I.__offset=y,y+=X.storage}}}const _=y%R;return _>0&&(y+=R-_),S.__size=y,S.__cache={},this}function d(S){const E={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(E.boundary=4,E.storage=4):S.isVector2?(E.boundary=8,E.storage=8):S.isVector3||S.isColor?(E.boundary=16,E.storage=12):S.isVector4?(E.boundary=16,E.storage=16):S.isMatrix3?(E.boundary=48,E.storage=48):S.isMatrix4?(E.boundary=64,E.storage=64):S.isTexture?De("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(E.boundary=16,E.storage=S.byteLength):De("WebGLRenderer: Unsupported uniform value type.",S),E}function T(S){const E=S.target;E.removeEventListener("dispose",T);const y=a.indexOf(E.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[E.id]),delete r[E.id],delete s[E.id]}function C(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:c,update:l,dispose:C}}const vm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let un=null;function xm(){return un===null&&(un=new cu(vm,16,16,$n,_n),un.name="DFG_LUT",un.minFilter=xt,un.magFilter=xt,un.wrapS=bn,un.wrapT=bn,un.generateMipmaps=!1,un.needsUpdate=!0),un}class Sm{constructor(e={}){const{canvas:t=Bc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:p="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:u=!1,outputBufferType:h=qt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=a;const M=h,g=new Set([pa,ha,fa]),d=new Set([qt,gn,Bi,zi,ua,da]),T=new Uint32Array(4),C=new Int32Array(4),S=new G;let E=null,y=null;const R=[],_=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,diagnostics:{keywords:!1},onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=sn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const D=this;let N=!1,B=null,k=null,I=null,H=null;this._outputColorSpace=Xt;let $=0,W=0,ne=null,X=-1,ee=null;const q=new ht,se=new ht;let ae=null;const Ne=new je(0);let Pe=0,Ge=t.width,Y=t.height,j=1,ve=null,Te=null;const ge=new ht(0,0,Ge,Y),Ce=new ht(0,0,Ge,Y);let nt=!1;const Be=new sl;let Ze=!1,at=!1;const He=new mt,ut=new G,Et=new ht,Nt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let dt=!1;function gt(){return ne===null?j:1}let L=n;function Tt(v,w){return t.getContext(v,w)}let et,b,m,U,z,K,re,oe,Z,Q,le,Ae,fe,ce,Re,Le,Ue,P,ue,J,de,_e,te;try{const v={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:p,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${la}`),t.addEventListener("webglcontextlost",ot,!1),t.addEventListener("webglcontextrestored",Je,!1),t.addEventListener("webglcontextcreationerror",Zt,!1),L===null){const w="webgl2";if(L=Tt(w,v),L===null)throw Tt(w)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}we()}catch(v){throw t.removeEventListener("webglcontextlost",ot,!1),t.removeEventListener("webglcontextrestored",Je,!1),t.removeEventListener("webglcontextcreationerror",Zt,!1),$e("WebGLRenderer: "+v.message),v}function we(){et=new xh(L),et.init(),de=new um(L,et),b=new ch(L,et,e,de),m=new lm(L,et),b.reversedDepthBuffer&&u&&m.buffers.depth.setReversed(!0),k=L.createFramebuffer(),I=L.createFramebuffer(),H=L.createFramebuffer(),U=new Eh(L),z=new Kp,K=new cm(L,et,m,z,b,de,U),re=new vh(D),oe=new yu(L),_e=new oh(L,oe),Z=new Sh(L,oe,U,_e),Q=new bh(L,Z,oe,_e,U),P=new yh(L,b,K),Re=new uh(z),le=new Yp(D,re,et,b,_e,Re),Ae=new gm(D,z),fe=new $p,ce=new nm(et),Ue=new ah(D,re,m,Q,x,c),Le=new om(D,Q,b),te=new _m(L,U,b,m),ue=new lh(L,et,U),J=new Mh(L,et,U),U.programs=le.programs,D.capabilities=b,D.extensions=et,D.properties=z,D.renderLists=fe,D.shadowMap=Le,D.state=m,D.info=U}M!==qt&&(A=new Ah(M,t.width,t.height,o,r,s));const ye=new pm(D,L);this.xr=ye,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const v=et.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=et.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return j},this.setPixelRatio=function(v){v!==void 0&&(j=v,this.setSize(Ge,Y,!1))},this.getSize=function(v){return v.set(Ge,Y)},this.setSize=function(v,w,V=!0){if(ye.isPresenting){De("WebGLRenderer: Can't change size while VR device is presenting.");return}Ge=v,Y=w,t.width=Math.floor(v*j),t.height=Math.floor(w*j),V===!0&&(t.style.width=v+"px",t.style.height=w+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,v,w)},this.getDrawingBufferSize=function(v){return v.set(Ge*j,Y*j).floor()},this.setDrawingBufferSize=function(v,w,V){Ge=v,Y=w,j=V,t.width=Math.floor(v*V),t.height=Math.floor(w*V),this.setViewport(0,0,v,w)},this.setEffects=function(v){if(M===qt){$e("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let w=0;w<v.length;w++)if(v[w].isOutputPass===!0){De("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(q)},this.getViewport=function(v){return v.copy(ge)},this.setViewport=function(v,w,V,F){v.isVector4?ge.set(v.x,v.y,v.z,v.w):ge.set(v,w,V,F),m.viewport(q.copy(ge).multiplyScalar(j).round())},this.getScissor=function(v){return v.copy(Ce)},this.setScissor=function(v,w,V,F){v.isVector4?Ce.set(v.x,v.y,v.z,v.w):Ce.set(v,w,V,F),m.scissor(se.copy(Ce).multiplyScalar(j).round())},this.getScissorTest=function(){return nt},this.setScissorTest=function(v){m.setScissorTest(nt=v)},this.setOpaqueSort=function(v){ve=v},this.setTransparentSort=function(v){Te=v},this.getClearColor=function(v){return v.copy(Ue.getClearColor())},this.setClearColor=function(){Ue.setClearColor(...arguments)},this.getClearAlpha=function(){return Ue.getClearAlpha()},this.setClearAlpha=function(){Ue.setClearAlpha(...arguments)},this.clear=function(v=!0,w=!0,V=!0){let F=0;if(v){let O=!1;if(ne!==null){const me=ne.texture.format;O=g.has(me)}if(O){const me=ne.texture.type,Se=d.has(me),pe=Ue.getClearColor(),Me=Ue.getClearAlpha(),be=pe.r,Fe=pe.g,ze=pe.b;Se?(T[0]=be,T[1]=Fe,T[2]=ze,T[3]=Me,L.clearBufferuiv(L.COLOR,0,T)):(C[0]=be,C[1]=Fe,C[2]=ze,C[3]=Me,L.clearBufferiv(L.COLOR,0,C))}else F|=L.COLOR_BUFFER_BIT}w&&(F|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(F|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),F!==0&&L.clear(F)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),B=v},this.dispose=function(){t.removeEventListener("webglcontextlost",ot,!1),t.removeEventListener("webglcontextrestored",Je,!1),t.removeEventListener("webglcontextcreationerror",Zt,!1),Ue.dispose(),fe.dispose(),ce.dispose(),z.dispose(),re.dispose(),Q.dispose(),_e.dispose(),te.dispose(),le.dispose(),ye.dispose(),ye.removeEventListener("sessionstart",Ea),ye.removeEventListener("sessionend",ya),zn.stop()};function ot(v){v.preventDefault(),Ha("WebGLRenderer: Context Lost."),N=!0}function Je(){Ha("WebGLRenderer: Context Restored."),N=!1;const v=U.autoReset,w=Le.enabled,V=Le.autoUpdate,F=Le.needsUpdate,O=Le.type;we(),U.autoReset=v,Le.enabled=w,Le.autoUpdate=V,Le.needsUpdate=F,Le.type=O}function Zt(v){$e("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function on(v){const w=v.target;w.removeEventListener("dispose",on),xl(w)}function xl(v){Sl(v),z.remove(v)}function Sl(v){const w=z.get(v).programs;w!==void 0&&(w.forEach(function(V){le.releaseProgram(V)}),v.isShaderMaterial&&le.releaseShaderCache(v))}this.renderBufferDirect=function(v,w,V,F,O,me){w===null&&(w=Nt);const Se=O.isMesh&&O.matrixWorld.determinantAffine()<0,pe=yl(v,w,V,F,O);m.setMaterial(F,Se);let Me=V.index,be=1;if(F.wireframe===!0){if(Me=Z.getWireframeAttribute(V),Me===void 0)return;be=2}const Fe=V.drawRange,ze=V.attributes.position;let Ee=Fe.start*be,Qe=(Fe.start+Fe.count)*be;me!==null&&(Ee=Math.max(Ee,me.start*be),Qe=Math.min(Qe,(me.start+me.count)*be)),Me!==null?(Ee=Math.max(Ee,0),Qe=Math.min(Qe,Me.count)):ze!=null&&(Ee=Math.max(Ee,0),Qe=Math.min(Qe,ze.count));const _t=Qe-Ee;if(_t<0||_t===1/0)return;_e.setup(O,F,pe,V,Me);let ct,st=ue;if(Me!==null&&(ct=oe.get(Me),st=J,st.setIndex(ct)),O.isMesh)F.wireframe===!0?(m.setLineWidth(F.wireframeLinewidth*gt()),st.setMode(L.LINES)):st.setMode(L.TRIANGLES);else if(O.isLine){let At=F.linewidth;At===void 0&&(At=1),m.setLineWidth(At*gt()),O.isLineSegments?st.setMode(L.LINES):O.isLineLoop?st.setMode(L.LINE_LOOP):st.setMode(L.LINE_STRIP)}else O.isPoints?st.setMode(L.POINTS):O.isSprite&&st.setMode(L.TRIANGLES);if(O.isBatchedMesh)if(et.get("WEBGL_multi_draw"))st.renderMultiDraw(O._multiDrawStarts,O._multiDrawCounts,O._multiDrawCount);else{const At=O._multiDrawStarts,xe=O._multiDrawCounts,Pt=O._multiDrawCount,qe=Me?oe.get(Me).bytesPerElement:1,Vt=z.get(F).currentProgram.getUniforms();for(let ln=0;ln<Pt;ln++)Vt.setValue(L,"_gl_DrawID",ln),st.render(At[ln]/qe,xe[ln])}else if(O.isInstancedMesh)st.renderInstances(Ee,_t,O.count);else if(V.isInstancedBufferGeometry){const At=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,xe=Math.min(V.instanceCount,At);st.renderInstances(Ee,_t,xe)}else st.render(Ee,_t)};function Ma(v,w,V,F){B!==null&&v.isNodeMaterial&&B.setObject(F,v),Ze===!0&&Re.setState(v,V,!1),v.transparent===!0&&v.side===fn&&v.forceSinglePass===!1?(v.side=Ot,v.needsUpdate=!0,qi(v,w,F),v.side=Kn,v.needsUpdate=!0,qi(v,w,F),v.side=fn):qi(v,w,F)}this.compile=function(v,w,V=null){V===null&&(V=v),B!==null&&B.renderStart(v,w,V),y=ce.get(V),y.init(w),_.push(y),V.traverseVisible(function(O){O.isLight&&O.layers.test(w.layers)&&(y.pushLight(O),O.castShadow&&y.pushShadow(O))}),v!==V&&v.traverseVisible(function(O){O.isLight&&O.layers.test(w.layers)&&(y.pushLight(O),O.castShadow&&y.pushShadow(O))}),y.setupLights(),B!==null&&B.updateLights(y.state.lightsArray),at=this.localClippingEnabled,Ze=Re.init(this.clippingPlanes,at),Ze===!0&&Re.setGlobalState(this.clippingPlanes,w),B!==null&&Le.render(y.state.shadowsArray,V,w);const F=new Set;return v.traverse(function(O){if(!(O.isMesh||O.isPoints||O.isLine||O.isSprite))return;const me=O.material;if(me)if(Array.isArray(me))for(let Se=0;Se<me.length;Se++){const pe=me[Se];Ma(pe,V,w,O),F.add(pe)}else Ma(me,V,w,O),F.add(me)}),y=_.pop(),B!==null&&B.renderEnd(),F},this.compileAsync=function(v,w,V=null){const F=this.compile(v,w,V);return new Promise(O=>{function me(){if(F.forEach(function(Se){const Me=z.get(Se).currentProgram;(Me===void 0||Me.isReady())&&F.delete(Se)}),F.size===0){O(v);return}setTimeout(me,10)}et.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let Nr=null;function Ml(v){Nr&&Nr(v)}function Ea(){zn.stop()}function ya(){zn.start()}const zn=new dl;zn.setAnimationLoop(Ml),typeof self<"u"&&zn.setContext(self),this.setAnimationLoop=function(v){Nr=v,ye.setAnimationLoop(v),v===null?zn.stop():zn.start()},ye.addEventListener("sessionstart",Ea),ye.addEventListener("sessionend",ya),this.render=function(v,w){if(w!==void 0&&w.isCamera!==!0){$e("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(N===!0)return;B!==null&&B.renderStart(v,w);const V=ye.enabled===!0&&ye.isPresenting===!0,F=A!==null&&(ne===null||V)&&A.begin(D,ne);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),w.parent===null&&w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),ye.enabled===!0&&ye.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(ye.cameraAutoUpdate===!0&&ye.updateCamera(w),w=ye.getCamera()),v.isScene===!0&&v.onBeforeRender(D,v,w,ne),y=ce.get(v,_.length),y.init(w),y.state.textureUnits=K.getTextureUnits(),_.push(y),He.multiplyMatrices(w.projectionMatrix,w.matrixWorldInverse),Be.setFromProjectionMatrix(He,pn,w.reversedDepth),at=this.localClippingEnabled,Ze=Re.init(this.clippingPlanes,at),E=fe.get(v,R.length),E.init(),R.push(E),ye.enabled===!0&&ye.isPresenting===!0){const Se=D.xr.getDepthSensingMesh();Se!==null&&Fr(Se,w,-1/0,D.sortObjects)}Fr(v,w,0,D.sortObjects),E.finish(),B!==null&&B.updateLights(y.state.lightsArray),D.sortObjects===!0&&E.sort(ve,Te),dt=ye.enabled===!1||ye.isPresenting===!1||ye.hasDepthSensing()===!1,dt&&Ue.addToRenderList(E,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Ze===!0&&Re.beginShadows();const O=y.state.shadowsArray;if(Le.render(O,v,w),Ze===!0&&Re.endShadows(),(F&&A.hasRenderPass())===!1){const Se=E.opaque,pe=E.transmissive;if(y.setupLights(),w.isArrayCamera){const Me=w.cameras;if(pe.length>0)for(let be=0,Fe=Me.length;be<Fe;be++){const ze=Me[be];Ta(Se,pe,v,ze)}dt&&Ue.render(v);for(let be=0,Fe=Me.length;be<Fe;be++){const ze=Me[be];ba(E,v,ze,ze.viewport)}}else pe.length>0&&Ta(Se,pe,v,w),dt&&Ue.render(v),ba(E,v,w)}ne!==null&&W===0&&(K.updateMultisampleRenderTarget(ne),K.updateRenderTargetMipmap(ne)),F&&A.end(D),v.isScene===!0&&v.onAfterRender(D,v,w),_e.resetDefaultState(),X=-1,ee=null,_.pop(),_.length>0?(y=_[_.length-1],K.setTextureUnits(y.state.textureUnits),Ze===!0&&Re.setGlobalState(D.clippingPlanes,y.state.camera)):y=null,R.pop(),R.length>0?E=R[R.length-1]:E=null,B!==null&&B.renderEnd()};function Fr(v,w,V,F){if(v.visible===!1)return;if(v.layers.test(w.layers)){if(v.isGroup)V=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(w);else if(v.isLightProbeGrid)y.pushLightProbeGrid(v);else if(v.isLight)y.pushLight(v),v.castShadow&&y.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||v.intersectsFrustum(Be)){F&&Et.setFromMatrixPosition(v.matrixWorld).applyMatrix4(He);const Se=Q.update(v),pe=v.material;pe.visible&&E.push(v,Se,pe,V,Et.z,null,w)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||v.intersectsFrustum(Be))){const Se=Q.update(v),pe=v.material;if(F&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),Et.copy(v.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Et.copy(Se.boundingSphere.center)),Et.applyMatrix4(v.matrixWorld).applyMatrix4(He)),Array.isArray(pe)){const Me=Se.groups;for(let be=0,Fe=Me.length;be<Fe;be++){const ze=Me[be],Ee=pe[ze.materialIndex];Ee&&Ee.visible&&E.push(v,Se,Ee,V,Et.z,ze,w)}}else pe.visible&&E.push(v,Se,pe,V,Et.z,null,w)}}const me=v.children;for(let Se=0,pe=me.length;Se<pe;Se++)Fr(me[Se],w,V,F)}function ba(v,w,V,F){const{opaque:O,transmissive:me,transparent:Se}=v;y.setupLightsView(V),Ze===!0&&Re.setGlobalState(D.clippingPlanes,V),F&&m.viewport(q.copy(F)),O.length>0&&Xi(O,w,V),me.length>0&&Xi(me,w,V),Se.length>0&&Xi(Se,w,V),m.buffers.depth.setTest(!0),m.buffers.depth.setMask(!0),m.buffers.color.setMask(!0),m.setPolygonOffset(!1)}function Ta(v,w,V,F){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(y.state.transmissionRenderTarget[F.id]===void 0){const Ee=et.has("EXT_color_buffer_half_float")||et.has("EXT_color_buffer_float");y.state.transmissionRenderTarget[F.id]=new Yt(1,1,{generateMipmaps:!0,type:Ee?_n:qt,minFilter:qn,samples:Math.max(4,b.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,storeMultisampledDepthBuffer:!1,storeMultisampledStencilBuffer:!1,colorSpace:ke.workingColorSpace})}const me=y.state.transmissionRenderTarget[F.id],Se=F.viewport||q;me.setSize(Se.z*D.transmissionResolutionScale,Se.w*D.transmissionResolutionScale);const pe=D.getRenderTarget(),Me=D.getActiveCubeFace(),be=D.getActiveMipmapLevel();D.setRenderTarget(me),D.getClearColor(Ne),Pe=D.getClearAlpha(),Pe<1&&D.setClearColor(16777215,.5),D.clear(),dt&&Ue.render(V);const Fe=D.toneMapping;D.toneMapping=sn;const ze=F.viewport;if(F.viewport!==void 0&&(F.viewport=void 0),y.setupLightsView(F),Ze===!0&&Re.setGlobalState(D.clippingPlanes,F),Xi(v,V,F),K.updateMultisampleRenderTarget(me),K.updateRenderTargetMipmap(me),et.has("WEBGL_multisampled_render_to_texture")===!1){let Ee=!1;for(let Qe=0,_t=w.length;Qe<_t;Qe++){const ct=w[Qe],{object:st,geometry:At,material:xe,group:Pt}=ct;if(xe.side===fn&&st.layers.test(F.layers)){const qe=xe.side;xe.side=Ot,xe.needsUpdate=!0,Aa(st,V,F,At,xe,Pt),xe.side=qe,xe.needsUpdate=!0,Ee=!0}}Ee===!0&&(K.updateMultisampleRenderTarget(me),K.updateRenderTargetMipmap(me))}D.setRenderTarget(pe,Me,be),D.setClearColor(Ne,Pe),ze!==void 0&&(F.viewport=ze),D.toneMapping=Fe}function Xi(v,w,V){const F=w.isScene===!0?w.overrideMaterial:null;for(let O=0,me=v.length;O<me;O++){const Se=v[O],{object:pe,geometry:Me,group:be}=Se;let Fe=Se.material;Fe.allowOverride===!0&&F!==null&&(Fe=F),pe.layers.test(V.layers)&&Aa(pe,w,V,Me,Fe,be)}}function Aa(v,w,V,F,O,me){B!==null&&O.isNodeMaterial&&B.setObject(v,O),v.onBeforeRender(D,w,V,F,O,me),v.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),O.onBeforeRender(D,w,V,F,v,me),O.transparent===!0&&O.side===fn&&O.forceSinglePass===!1?(O.side=Ot,O.needsUpdate=!0,D.renderBufferDirect(V,w,F,O,v,me),O.side=Kn,O.needsUpdate=!0,D.renderBufferDirect(V,w,F,O,v,me),O.side=fn):D.renderBufferDirect(V,w,F,O,v,me),v.onAfterRender(D,w,V,F,O,me)}function qi(v,w,V){w.isScene!==!0&&(w=Nt);const F=z.get(v),O=y.state.lights,me=y.state.shadowsArray,Se=O.state.version,pe=le.getParameters(v,O.state,me,w,V,y.state.lightProbeGridArray),Me=le.getProgramCacheKey(pe);let be=F.programs;F.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?w.environment:null,F.fog=w.fog;const Fe=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;F.envMap=re.get(v.envMap||F.environment,Fe),F.envMapRotation=F.environment!==null&&v.envMap===null?w.environmentRotation:v.envMapRotation,be===void 0&&(v.addEventListener("dispose",on),be=new Map,F.programs=be);let ze=be.get(Me);if(ze!==void 0){if(F.currentProgram===ze&&F.lightsStateVersion===Se)return wa(v,pe),ze}else pe.uniforms=le.getUniforms(v),B!==null&&v.isNodeMaterial&&B.build(v,V,pe),v.onBeforeCompile(pe,D),ze=le.acquireProgram(pe,Me),be.set(Me,ze),F.uniforms=pe.uniforms;const Ee=F.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Ee.clippingPlanes=Re.uniform),wa(v,pe),F.needsLights=Tl(v),F.lightsStateVersion=Se,F.needsLights&&(Ee.ambientLightColor.value=O.state.ambient,Ee.lightProbe.value=O.state.probe,Ee.sunLights.value=O.state.sun,Ee.sunLightShadows.value=O.state.sunShadow,Ee.directionalLights.value=O.state.directional,Ee.directionalLightShadows.value=O.state.directionalShadow,Ee.spotLights.value=O.state.spot,Ee.spotLightShadows.value=O.state.spotShadow,Ee.rectAreaLights.value=O.state.rectArea,Ee.ltc_1.value=O.state.rectAreaLTC1,Ee.ltc_2.value=O.state.rectAreaLTC2,Ee.pointLights.value=O.state.point,Ee.pointLightShadows.value=O.state.pointShadow,Ee.hemisphereLights.value=O.state.hemi,Ee.sunShadowMatrix.value=O.state.sunShadowMatrix,Ee.sunShadowCascade.value=O.state.sunShadowCascade,Ee.directionalShadowMatrix.value=O.state.directionalShadowMatrix,Ee.spotLightMatrix.value=O.state.spotLightMatrix,Ee.spotLightMap.value=O.state.spotLightMap,Ee.pointShadowMatrix.value=O.state.pointShadowMatrix),F.lightProbeGrid=y.state.lightProbeGridArray.length>0,F.currentProgram=ze,F.uniformsList=null,ze}function Ra(v){if(v.uniformsList===null){const w=v.currentProgram.getUniforms();v.uniformsList=Er.seqWithValue(w.seq,v.uniforms)}return v.uniformsList}function wa(v,w){const V=z.get(v);V.outputColorSpace=w.outputColorSpace,V.batching=w.batching,V.batchingColor=w.batchingColor,V.instancing=w.instancing,V.instancingColor=w.instancingColor,V.instancingMorph=w.instancingMorph,V.skinning=w.skinning,V.morphTargets=w.morphTargets,V.morphNormals=w.morphNormals,V.morphColors=w.morphColors,V.morphTargetsCount=w.morphTargetsCount,V.numClippingPlanes=w.numClippingPlanes,V.numIntersection=w.numClipIntersection,V.vertexAlphas=w.vertexAlphas,V.vertexTangents=w.vertexTangents,V.toneMapping=w.toneMapping}function El(v,w){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;S.setFromMatrixPosition(w.matrixWorld);for(let V=0,F=v.length;V<F;V++){const O=v[V];if(O.texture!==null&&O.boundingBox.containsPoint(S))return O}return null}function yl(v,w,V,F,O){w.isScene!==!0&&(w=Nt),K.resetTextureUnits();const me=w.fog,Se=F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial?w.environment:null,pe=ne===null?D.outputColorSpace:ne.isXRRenderTarget===!0?ne.texture.colorSpace:ke.workingColorSpace,Me=F.isMeshStandardMaterial||F.isMeshLambertMaterial&&!F.envMap||F.isMeshPhongMaterial&&!F.envMap,be=re.get(F.envMap||Se,Me),Fe=F.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,ze=!!V.attributes.tangent&&(!!F.normalMap||F.anisotropy>0),Ee=!!V.morphAttributes.position,Qe=!!V.morphAttributes.normal,_t=!!V.morphAttributes.color;let ct=sn;F.toneMapped&&(ne===null||ne.isXRRenderTarget===!0)&&(ct=D.toneMapping);const st=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,At=st!==void 0?st.length:0,xe=z.get(F),Pt=y.state.lights;if(Ze===!0&&(at===!0||v!==ee)){const lt=v===ee&&F.id===X;Re.setState(F,v,lt)}let qe=!1;F.version===xe.__version?(xe.needsLights&&xe.lightsStateVersion!==Pt.state.version||xe.outputColorSpace!==pe||O.isBatchedMesh&&xe.batching===!1||!O.isBatchedMesh&&xe.batching===!0||O.isBatchedMesh&&xe.batchingColor===!0&&O._colorsTexture===null||O.isBatchedMesh&&xe.batchingColor===!1&&O._colorsTexture!==null||O.isInstancedMesh&&xe.instancing===!1||!O.isInstancedMesh&&xe.instancing===!0||O.isSkinnedMesh&&xe.skinning===!1||!O.isSkinnedMesh&&xe.skinning===!0||O.isInstancedMesh&&xe.instancingColor===!0&&O.instanceColor===null||O.isInstancedMesh&&xe.instancingColor===!1&&O.instanceColor!==null||O.isInstancedMesh&&xe.instancingMorph===!0&&O.morphTexture===null||O.isInstancedMesh&&xe.instancingMorph===!1&&O.morphTexture!==null||xe.envMap!==be||F.fog===!0&&xe.fog!==me||xe.numClippingPlanes!==void 0&&(xe.numClippingPlanes!==Re.numPlanes||xe.numIntersection!==Re.numIntersection)||xe.vertexAlphas!==Fe||xe.vertexTangents!==ze||xe.morphTargets!==Ee||xe.morphNormals!==Qe||xe.morphColors!==_t||xe.toneMapping!==ct||xe.morphTargetsCount!==At||!!xe.lightProbeGrid!=y.state.lightProbeGridArray.length>0)&&(qe=!0):(qe=!0,xe.__version=F.version);let Vt=xe.currentProgram;qe===!0&&(Vt=qi(F,w,O),B&&F.isNodeMaterial&&B.onUpdateProgram(F,Vt,xe));let ln=!1,wn=!1,jn=!1;const it=Vt.getUniforms(),pt=xe.uniforms;if(m.useProgram(Vt.program)&&(ln=!0,wn=!0,jn=!0),F.id!==X&&(X=F.id,wn=!0),xe.needsLights){const lt=El(y.state.lightProbeGridArray,O);xe.lightProbeGrid!==lt&&(xe.lightProbeGrid=lt,wn=!0)}if(ln||ee!==v){m.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),it.setValue(L,"projectionMatrix",v.projectionMatrix),it.setValue(L,"viewMatrix",v.matrixWorldInverse);const Pn=it.map.cameraPosition;Pn!==void 0&&Pn.setValue(L,ut.setFromMatrixPosition(v.matrixWorld)),b.logarithmicDepthBuffer&&it.setValue(L,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(F.isMeshPhongMaterial||F.isMeshToonMaterial||F.isMeshLambertMaterial||F.isMeshBasicMaterial||F.isMeshStandardMaterial||F.isShaderMaterial)&&it.setValue(L,"isOrthographic",v.isOrthographicCamera===!0),ee!==v&&(ee=v,wn=!0,jn=!0)}if(xe.needsLights&&(Pt.state.sunShadowMap.length>0&&it.setValue(L,"sunShadowMap",Pt.state.sunShadowMap,K),Pt.state.directionalShadowMap.length>0&&it.setValue(L,"directionalShadowMap",Pt.state.directionalShadowMap,K),Pt.state.spotShadowMap.length>0&&it.setValue(L,"spotShadowMap",Pt.state.spotShadowMap,K),Pt.state.pointShadowMap.length>0&&it.setValue(L,"pointShadowMap",Pt.state.pointShadowMap,K)),O.isSkinnedMesh){it.setOptional(L,O,"bindMatrix"),it.setOptional(L,O,"bindMatrixInverse");const lt=O.skeleton;lt&&(lt.boneTexture===null&&lt.computeBoneTexture(),it.setValue(L,"boneTexture",lt.boneTexture,K))}O.isBatchedMesh&&(it.setOptional(L,O,"batchingTexture"),it.setValue(L,"batchingTexture",O._matricesTexture,K),it.setOptional(L,O,"batchingIdTexture"),it.setValue(L,"batchingIdTexture",O._indirectTexture,K),it.setOptional(L,O,"batchingColorTexture"),O._colorsTexture!==null&&it.setValue(L,"batchingColorTexture",O._colorsTexture,K));const Cn=V.morphAttributes;if((Cn.position!==void 0||Cn.normal!==void 0||Cn.color!==void 0)&&P.update(O,V,Vt),(wn||xe.receiveShadow!==O.receiveShadow)&&(xe.receiveShadow=O.receiveShadow,it.setValue(L,"receiveShadow",O.receiveShadow)),(F.isMeshStandardMaterial||F.isMeshLambertMaterial||F.isMeshPhongMaterial)&&F.envMap===null&&w.environment!==null&&(pt.envMapIntensity.value=w.environmentIntensity),pt.dfgLUT!==void 0&&(pt.dfgLUT.value=xm()),wn){if(it.setValue(L,"toneMappingExposure",D.toneMappingExposure),xe.needsLights&&bl(pt,jn),me&&F.fog===!0&&Ae.refreshFogUniforms(pt,me),Ae.refreshMaterialUniforms(pt,F,j,Y,y.state.transmissionRenderTarget[v.id]),xe.needsLights&&xe.lightProbeGrid){const lt=xe.lightProbeGrid;pt.probesSH.value=lt.texture,pt.probesMin.value.copy(lt.boundingBox.min),pt.probesMax.value.copy(lt.boundingBox.max),pt.probesResolution.value.copy(lt.resolution)}Er.upload(L,Ra(xe),pt,K)}if(F.isShaderMaterial&&F.uniformsNeedUpdate===!0&&(Er.upload(L,Ra(xe),pt,K),F.uniformsNeedUpdate=!1),F.isSpriteMaterial&&it.setValue(L,"center",O.center),it.setValue(L,"modelViewMatrix",O.modelViewMatrix),it.setValue(L,"normalMatrix",O.normalMatrix),it.setValue(L,"modelMatrix",O.matrixWorld),F.uniformsGroups!==void 0){const lt=F.uniformsGroups;for(let Pn=0,ei=lt.length;Pn<ei;Pn++){const Pa=lt[Pn];te.update(Pa,Vt),te.bind(Pa,Vt)}}return Vt}function bl(v,w){v.ambientLightColor.needsUpdate=w,v.lightProbe.needsUpdate=w,v.sunLights.needsUpdate=w,v.sunLightShadows.needsUpdate=w,v.directionalLights.needsUpdate=w,v.directionalLightShadows.needsUpdate=w,v.pointLights.needsUpdate=w,v.pointLightShadows.needsUpdate=w,v.spotLights.needsUpdate=w,v.spotLightShadows.needsUpdate=w,v.rectAreaLights.needsUpdate=w,v.hemisphereLights.needsUpdate=w}function Tl(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return $},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return ne},this.setRenderTargetTextures=function(v,w,V){const F=z.get(v);F.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,F.__autoAllocateDepthBuffer===!1&&(F.__useRenderToTexture=!1),z.get(v.texture).__webglTexture=w,z.get(v.depthTexture).__webglTexture=F.__autoAllocateDepthBuffer?void 0:V,F.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,w){const V=z.get(v);V.__webglFramebuffer=w,V.__useDefaultFramebuffer=w===void 0},this.setRenderTarget=function(v,w=0,V=0){ne=v,$=w,W=V;let F=null,O=!1,me=!1;if(v){const pe=z.get(v);if(pe.__useDefaultFramebuffer!==void 0){m.bindFramebuffer(L.FRAMEBUFFER,pe.__webglFramebuffer),q.copy(v.viewport),se.copy(v.scissor),ae=v.scissorTest,m.viewport(q),m.scissor(se),m.setScissorTest(ae),X=-1;return}else if(pe.__webglFramebuffer===void 0)K.setupRenderTarget(v);else if(pe.__hasExternalTextures)K.rebindTextures(v,z.get(v.texture).__webglTexture,z.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Fe=v.depthTexture;if(pe.__boundDepthTexture!==Fe){if(Fe!==null&&z.has(Fe)&&(v.width!==Fe.image.width||v.height!==Fe.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");K.setupDepthRenderbuffer(v)}}const Me=v.texture;(Me.isData3DTexture||Me.isDataArrayTexture||Me.isCompressedArrayTexture)&&(me=!0);const be=z.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(be[w])?F=be[w][V]:F=be[w],O=!0):v.samples>0&&K.useMultisampledRTT(v)===!1?F=z.get(v).__webglMultisampledFramebuffer:Array.isArray(be)?F=be[V]:F=be,q.copy(v.viewport),se.copy(v.scissor),ae=v.scissorTest}else q.copy(ge).multiplyScalar(j).floor(),se.copy(Ce).multiplyScalar(j).floor(),ae=nt;if(V!==0&&(F=k),m.bindFramebuffer(L.FRAMEBUFFER,F)&&m.drawBuffers(v,F),m.viewport(q),m.scissor(se),m.setScissorTest(ae),O){const pe=z.get(v.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+w,pe.__webglTexture,V)}else if(me){const pe=w;for(let Me=0;Me<v.textures.length;Me++){const be=z.get(v.textures[Me]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+Me,be.__webglTexture,V,pe)}}else if(v!==null&&V!==0){const pe=z.get(v.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,pe.__webglTexture,V)}X=-1};function Ca(v){const w=z.get(v);return(w.__readFormat!==v.format||w.__readType!==v.type)&&(w.__readFormat=v.format,w.__readType=v.type,w.__formatReadable=b.textureFormatReadable(v.format),w.__typeReadable=b.textureTypeReadable(v.type)),w}this.readRenderTargetPixels=function(v,w,V,F,O,me,Se,pe=0){if(!(v&&v.isWebGLRenderTarget)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Me=z.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Se!==void 0&&(Me=Me[Se]),Me){m.bindFramebuffer(L.FRAMEBUFFER,Me);try{const be=v.textures[pe],Fe=be.format,ze=be.type;v.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+pe);const Ee=Ca(be);if(Ee.__formatReadable===!1){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(Ee.__typeReadable===!1){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}w>=0&&w<=v.width-F&&V>=0&&V<=v.height-O&&L.readPixels(w,V,F,O,de.convert(Fe),de.convert(ze),me)}finally{const be=ne!==null?z.get(ne).__webglFramebuffer:null;m.bindFramebuffer(L.FRAMEBUFFER,be)}}},this.readRenderTargetPixelsAsync=async function(v,w,V,F,O,me,Se,pe=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Me=z.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&Se!==void 0&&(Me=Me[Se]),Me)if(w>=0&&w<=v.width-F&&V>=0&&V<=v.height-O){m.bindFramebuffer(L.FRAMEBUFFER,Me);const be=v.textures[pe],Fe=be.format,ze=be.type;v.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+pe);const Ee=Ca(be);if(Ee.__formatReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(Ee.__typeReadable===!1)throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qe=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,Qe),L.bufferData(L.PIXEL_PACK_BUFFER,me.byteLength,L.STREAM_READ),L.readPixels(w,V,F,O,de.convert(Fe),de.convert(ze),0),L.bindBuffer(L.PIXEL_PACK_BUFFER,null);const _t=ne!==null?z.get(ne).__webglFramebuffer:null;m.bindFramebuffer(L.FRAMEBUFFER,_t);const ct=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await zc(L,ct,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,Qe),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,me),L.bindBuffer(L.PIXEL_PACK_BUFFER,null),L.deleteBuffer(Qe),L.deleteSync(ct),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,w=null,V=0){const F=Math.pow(2,-V),O=Math.floor(v.image.width*F),me=Math.floor(v.image.height*F),Se=w!==null?w.x:0,pe=w!==null?w.y:0;K.setTexture2D(v,0),L.copyTexSubImage2D(L.TEXTURE_2D,V,0,0,Se,pe,O,me),m.unbindTexture()},this.copyTextureToTexture=function(v,w,V=null,F=null,O=0,me=0){let Se,pe,Me,be,Fe,ze,Ee,Qe,_t;const ct=v.isCompressedTexture?v.mipmaps[me]:v.image;if(V!==null)Se=V.max.x-V.min.x,pe=V.max.y-V.min.y,Me=V.isBox3?V.max.z-V.min.z:1,be=V.min.x,Fe=V.min.y,ze=V.isBox3?V.min.z:0;else{const pt=Math.pow(2,-O);Se=Math.floor(ct.width*pt),pe=Math.floor(ct.height*pt),v.isDataArrayTexture?Me=ct.depth:v.isData3DTexture?Me=Math.floor(ct.depth*pt):Me=1,be=0,Fe=0,ze=0}F!==null?(Ee=F.x,Qe=F.y,_t=F.z):(Ee=0,Qe=0,_t=0);const st=de.convert(w.format),At=de.convert(w.type);let xe;w.isData3DTexture?(K.setTexture3D(w,0),xe=L.TEXTURE_3D):w.isDataArrayTexture||w.isCompressedArrayTexture?(K.setTexture2DArray(w,0),xe=L.TEXTURE_2D_ARRAY):(K.setTexture2D(w,0),xe=L.TEXTURE_2D),m.activeTexture(L.TEXTURE0),m.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,w.flipY),m.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,w.premultiplyAlpha),m.pixelStorei(L.UNPACK_ALIGNMENT,w.unpackAlignment);const Pt=m.getParameter(L.UNPACK_ROW_LENGTH),qe=m.getParameter(L.UNPACK_IMAGE_HEIGHT),Vt=m.getParameter(L.UNPACK_SKIP_PIXELS),ln=m.getParameter(L.UNPACK_SKIP_ROWS),wn=m.getParameter(L.UNPACK_SKIP_IMAGES);m.pixelStorei(L.UNPACK_ROW_LENGTH,ct.width),m.pixelStorei(L.UNPACK_IMAGE_HEIGHT,ct.height),m.pixelStorei(L.UNPACK_SKIP_PIXELS,be),m.pixelStorei(L.UNPACK_SKIP_ROWS,Fe),m.pixelStorei(L.UNPACK_SKIP_IMAGES,ze);const jn=v.isDataArrayTexture||v.isData3DTexture,it=w.isDataArrayTexture||w.isData3DTexture;if(v.isDepthTexture){const pt=z.get(v),Cn=z.get(w),lt=z.get(pt.__renderTarget),Pn=z.get(Cn.__renderTarget);m.bindFramebuffer(L.READ_FRAMEBUFFER,lt.__webglFramebuffer),m.bindFramebuffer(L.DRAW_FRAMEBUFFER,Pn.__webglFramebuffer);for(let ei=0;ei<Me;ei++)jn&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(v).__webglTexture,O,ze+ei),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,z.get(w).__webglTexture,me,_t+ei)),L.blitFramebuffer(be,Fe,Se,pe,Ee,Qe,Se,pe,L.DEPTH_BUFFER_BIT,L.NEAREST);m.bindFramebuffer(L.READ_FRAMEBUFFER,null),m.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(O!==0||v.isRenderTargetTexture||z.has(v)){const pt=z.get(v),Cn=z.get(w);m.bindFramebuffer(L.READ_FRAMEBUFFER,I),m.bindFramebuffer(L.DRAW_FRAMEBUFFER,H);for(let lt=0;lt<Me;lt++)jn?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,pt.__webglTexture,O,ze+lt):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,pt.__webglTexture,O),it?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Cn.__webglTexture,me,_t+lt):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Cn.__webglTexture,me),O!==0?L.blitFramebuffer(be,Fe,Se,pe,Ee,Qe,Se,pe,L.COLOR_BUFFER_BIT,L.NEAREST):it?L.copyTexSubImage3D(xe,me,Ee,Qe,_t+lt,be,Fe,Se,pe):L.copyTexSubImage2D(xe,me,Ee,Qe,be,Fe,Se,pe);m.bindFramebuffer(L.READ_FRAMEBUFFER,null),m.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else it?v.isDataTexture||v.isData3DTexture?L.texSubImage3D(xe,me,Ee,Qe,_t,Se,pe,Me,st,At,ct.data):w.isCompressedArrayTexture?L.compressedTexSubImage3D(xe,me,Ee,Qe,_t,Se,pe,Me,st,ct.data):L.texSubImage3D(xe,me,Ee,Qe,_t,Se,pe,Me,st,At,ct):v.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,me,Ee,Qe,Se,pe,st,At,ct.data):v.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,me,Ee,Qe,ct.width,ct.height,st,ct.data):L.texSubImage2D(L.TEXTURE_2D,me,Ee,Qe,Se,pe,st,At,ct);m.pixelStorei(L.UNPACK_ROW_LENGTH,Pt),m.pixelStorei(L.UNPACK_IMAGE_HEIGHT,qe),m.pixelStorei(L.UNPACK_SKIP_PIXELS,Vt),m.pixelStorei(L.UNPACK_SKIP_ROWS,ln),m.pixelStorei(L.UNPACK_SKIP_IMAGES,wn),me===0&&w.generateMipmaps&&L.generateMipmap(xe),m.unbindTexture()},this.initRenderTarget=function(v){z.get(v).__webglFramebuffer===void 0&&K.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?K.setTextureCube(v,0):v.isData3DTexture?K.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?K.setTexture2DArray(v,0):K.setTexture2D(v,0),m.unbindTexture()},this.resetState=function(){$=0,W=0,ne=null,m.reset(),_e.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return pn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}const Po=`
varying vec3 vPosition;
varying vec3 vWorld;
varying vec3 vNormal;
void main() {
...
`,Mi=" .:-=+*#%@";function Am(){const i=document.createElement("canvas"),e=32,t=44;i.width=e*Mi.length,i.height=t;const n=i.getContext("2d");if(!n)throw new Error("ASCII glyph atlas is unavailable");n.fillStyle="#fff",n.font="600 32px monospace",n.textAlign="center",n.textBaseline="middle",Array.from(Mi).forEach((s,a)=>{n.fillText(s,(a+.5)*e,t/2)});const r=new du(i);return r.minFilter=xt,r.magFilter=xt,r.generateMipmaps=!1,r}const Fn={cellWidth:7.5,cellHeight:10.5,brightness:12,contrast:115,vignette:38,bloom:25,animSpeed:100,animIntensity:60};function Rm(i,e=!1,t=1){const n=new Sm({canvas:i,alpha:!0,antialias:!1,premultipliedAlpha:!1,powerPreference:"low-power"});n.setClearColor(0,0),n.toneMapping=sn;const r=new Qa,s=new Pr(-2.35,2.35,1.8,-1.8,.1,20);s.position.set(0,0,7),s.lookAt(0,0,0);const a=new Ui;a.rotation.set(.43,0,-.38),a.scale.setScalar(t),r.add(a),a.updateMatrixWorld(!0);const o=new G(-3,5,5).normalize(),c=new G(0,1,0).applyQuaternion(a.quaternion),l=new Ht({vertexShader:Po,fragmentShader:Em,uniforms:{uLight:{value:o},uRingNormal:{value:c},uTime:{value:0},uWaveAmplitude:{value:.02*Fn.animIntensity/100}}}),p=new Sa(1,128,64),f=new Kt(p,l);f.name="Banded gas giant",a.add(f);const u=new Ht({vertexShader:Po,fragmentShader:ym,uniforms:{uLight:{value:o}},transparent:!0,side:fn,depthWrite:!1}),h=new xa(1.32,2.08,256,8),x=new Kt(h,u);x.name="Equatorial rings with Cassini gap",x.rotation.x=-Math.PI/2,a.add(x);const M=new Yt(1024,768,{minFilter:xt,magFilter:xt}),g=new Qa,d=new Pr(-1,1,1,-1,0,1),T=Am(),C=new Ht({vertexShader:bm,fragmentShader:Tm,depthTest:!1,depthWrite:!1,blending:mn,uniforms:{uScene:{value:M.texture},uGrid:{value:new Ke(128,96)},uGlyphs:{value:T},uGlyphCount:{value:Mi.length},uDark:{value:e?1:0},uBrightness:{value:Fn.brightness/100},uContrast:{value:Fn.contrast/100},uVignette:{value:Fn.vignette/100},uBloom:{value:Fn.bloom/100}}}),S=new Wi(2,2);return g.add(new Kt(S,C)),{resize(E,y){const R=E/Math.max(1,y);n.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),n.setSize(E,y,!1),C.uniforms.uGrid.value.set(Math.max(1,Math.round(E/Fn.cellWidth)),Math.max(1,Math.round(y/Fn.cellHeight)));const _=Math.min(1024,Math.max(512,Math.round(E*1.5)));M.setSize(_,Math.round(_/R)),s.top=2.35/R,s.bottom=-s.top,s.updateProjectionMatrix()},setTheme(E){C.uniforms.uDark.value=E?1:0},render(E){f.rotation.y=E*.07,l.uniforms.uTime.value=E*Fn.animSpeed/100,n.setRenderTarget(M),n.clear(),n.render(r,s),n.setRenderTarget(null),n.clear(),n.render(g,d)},dispose(){p.dispose(),h.dispose(),S.dispose(),l.dispose(),u.dispose(),C.dispose(),T.dispose(),M.dispose(),n.dispose()}}}function wm(i=61,e=31){return Array.from({length:e},(t,n)=>Array.from({length:i},(r,s)=>{const a=(s/(i-1)-.5)*2.6,o=(n/(e-1)-.5)*1.9,c=a*.92+o*.39,l=-a*.39+o*.92,p=a*a+o*o<.54**2,f=Math.hypot(c,l/.3),u=f>.72&&f<1.14&&Math.abs(f-.96)>.025;if(!p&&!u)return" ";const h=p?.48+.24*Math.sqrt(1-(a*a+o*o)/.54**2)-.15*a-.15*o+Math.sin(l*40)*.13:.4+Math.sin(f*90)*.18;return Mi[Math.min(Mi.length-1,Math.max(1,Math.floor(h*Mi.length)))]}).join("")).join(`
`)}const Cm={key:0,class:"planet-fallback",role:"img","aria-label":"由橙色字符组成的静态行星与星环"},Pm={"aria-hidden":"true"},Lm=aa({__name:"PixelPlanet",props:{scale:{default:1.18}},setup(i){const e=i,t=Xn(null),n=Xn(null),r=Xn(!1),s=Cl(),a=Pl(),o=wm();let c=null,l=null,p=null,f=0,u=0,h=0,x=-1/0,M=!0,g=!1;function d(R){f=0,!(g||r.value||!c||!M||document.hidden||s.value)&&(u+=Math.min((R-h)/1e3,.1),h=R,R-x>=1e3/30&&(c.render(u),x=R),f=requestAnimationFrame(d))}function T(){cancelAnimationFrame(f),f=0,!(g||r.value||!c)&&(c.render(u),h=performance.now(),x=-1/0,M&&!document.hidden&&!s.value&&(f=requestAnimationFrame(d)))}function C(){!t.value||!c||(c.resize(Math.max(1,t.value.clientWidth),Math.max(1,t.value.clientHeight)),T())}function S(R){R.preventDefault(),cancelAnimationFrame(f),r.value=!0,c?.dispose(),c=null}function E(){y()}function y(){if(!(!n.value||g))try{c=Rm(n.value,a.isDark,e.scale),r.value=!1,C()}catch{r.value=!0,c?.dispose(),c=null}}return Lo(()=>{y(),l=new ResizeObserver(C),p=new IntersectionObserver(([R])=>{M=R.isIntersecting,T()}),t.value&&(l.observe(t.value),p.observe(t.value)),n.value?.addEventListener("webglcontextlost",S),n.value?.addEventListener("webglcontextrestored",E),document.addEventListener("visibilitychange",T)}),ms(s,T),ms(()=>a.isDark,R=>{c?.setTheme(R),T()}),Do(()=>{g=!0,cancelAnimationFrame(f),l?.disconnect(),p?.disconnect(),n.value?.removeEventListener("webglcontextlost",S),n.value?.removeEventListener("webglcontextrestored",E),document.removeEventListener("visibilitychange",T),c?.dispose(),c=null}),(R,_)=>(Xe(),rt("div",{ref_key:"host",ref:t,class:"pixel-planet"},[ie("canvas",{ref_key:"canvas",ref:n,class:Io({unavailable:r.value}),role:"img","aria-label":"由橙色 ASCII 字符组成、缓慢自转的行星与星环"},null,2),r.value?(Xe(),rt("div",Cm,[ie("pre",Pm,Ye(Ve(o)),1)])):yr("",!0)],512))}}),Dm=oa(Lm,[["__scopeId","data-v-201d67de"]]),Im={class:"home-page relative"},Um={class:"home-hero shell-wide","aria-labelledby":"home-title"},Nm={class:"hero-copy"},Fm={id:"home-title"},Om={class:"hero-intro"},Bm={class:"hero-actions"},zm={class:"hero-visual","aria-hidden":"true"},Gm={class:"hero-overview"},Hm={class:"overview-label"},Vm={class:"latest-description line-clamp-2"},km={class:"latest-meta"},Wm=["datetime"],Xm={class:"truncate"},qm={class:"hero-shortcuts","aria-label":"探索花园"},Ym={class:"shortcut-heading"},Km={class:"shortcut-caption"},Zm={class:"shortcut-value"},$m={class:"shell-wide pt-20"},Jm={class:"flex flex-wrap items-end justify-between gap-4"},Qm={class:"mt-8 grid gap-6 md:grid-cols-2 xl:grid-cols-3"},jm={class:"flex items-center justify-between gap-3"},eg={class:"font-mono text-[0.7rem] text-faint"},tg={class:"mt-5 font-serif text-[1.32rem] leading-snug tracking-[-0.02em] transition-colors duration-300 group-hover:text-ember"},ng={class:"mt-2.5 line-clamp-2 text-[0.82rem] leading-relaxed text-muted"},ig={class:"mt-auto flex items-center justify-between pt-5 font-mono text-[0.7rem] text-faint"},rg={class:"truncate"},sg={class:"flex shrink-0 items-center gap-2"},ag={class:"shell-wide pt-20"},og={class:"grid gap-8 rounded-[8px] border border-line bg-paper-2/70 p-6 sm:p-9 lg:grid-cols-[1fr_1.25fr]"},lg={class:"grid gap-3 sm:grid-cols-3"},cg={class:"text-2xl","aria-hidden":"true"},ug={class:"mt-3 font-serif text-lg leading-none"},dg={class:"mt-1.5 text-[0.72rem] text-muted"},fg={class:"shell-wide pt-20"},hg={class:"flex flex-wrap items-end justify-between gap-4"},pg={class:"mt-8 grid gap-6 lg:grid-cols-3"},mg=["href"],gg={class:"relative flex items-start justify-between gap-3"},_g={class:"font-mono text-[0.7rem] tracking-[0.13em] text-ember"},vg={class:"relative mt-8 font-serif text-2xl tracking-[-0.03em]"},xg={class:"relative mt-1 text-[0.74rem] text-ember/85"},Sg={class:"relative mt-3 line-clamp-3 text-[0.82rem] leading-relaxed text-muted"},Mg={class:"relative mt-auto flex flex-wrap items-center gap-1.5 pt-5"},Eg={class:"shell-wide pt-20"},yg={class:"grid divide-line overflow-hidden rounded-[8px] border border-line bg-paper sm:grid-cols-2 lg:grid-cols-4 lg:divide-x"},bg={class:"font-mono text-[0.7rem] tracking-[0.14em] text-ember uppercase"},Tg={class:"mt-2 font-serif text-[1.05rem] leading-snug"},Ag={class:"shell-wide pt-16"},Rg={class:"grid gap-3 sm:grid-cols-2 lg:grid-cols-4"},wg={class:"block text-[0.9rem] transition-colors group-hover:text-ember"},Cg={class:"block font-mono text-[0.7rem] tracking-[0.12em] text-faint uppercase"},Pg=240,Lg=46,Dg=aa({__name:"HomePage",setup(i){const e=Ll(),t=["让作品与想法，","一起生长。"],r=Pg+0,s=Lg,a=yn(()=>e.notes[0]),o=yn(()=>e.notes.slice(0,5)),c=yn(()=>Object.keys(La).map(p=>({key:p,...La[p],count:e.stats.statusCount[p]}))),l=[{key:"notes",cjk:"知识笔记",value:()=>`${e.stats.total}`,to:"/notes",icon:Hl},{key:"projects",cjk:"项目路径",value:()=>`${Da.length}`,to:"/projects",icon:Vl},{key:"lab",cjk:"狐狸实验室",value:()=>"LAB",to:"/lab",icon:kl},{key:"github",cjk:"开源足迹",value:()=>"OSS",to:"https://github.com/DanoAndHolidays",icon:Il}];return(p,f)=>{const u=Fl("reveal");return Xe(),rt("div",Im,[ie("section",Um,[f[7]||(f[7]=ie("div",{class:"hero-rail"},[ie("span",{class:"hero-kicker"},[ie("i",{"aria-hidden":"true"}),Lt("DANO’S DIGITAL GARDEN")]),ie("span",{class:"hero-rail-note"},"记录、创造，保持好奇。")],-1)),ie("div",Nm,[ie("h1",Fm,[ft(Ia,{as:"span",text:t[0],trigger:"mount",stagger:Ve(s),"start-delay":r,loop:!1},null,8,["text","stagger"]),ft(Ia,{as:"span",class:"hero-title-secondary",text:t[1],trigger:"mount",stagger:Ve(s),"start-delay":r+t[0].length*Ve(s),loop:!1},null,8,["text","stagger","start-delay"])]),ie("p",Om,[Lt("我是 "+Ye(Ve(Yi).name)+"，一名前端开发者。",1),f[0]||(f[0]=ie("br",{class:"sm:hidden"},null,-1)),f[1]||(f[1]=Lt("在这里写代码，也照料想法。",-1)),f[2]||(f[2]=ie("br",{class:"hidden sm:block"},null,-1)),f[3]||(f[3]=Lt("我的项目、经历与持续更新的技术笔记，都在这座数字花园里。",-1))]),ie("div",Bm,[ft(Ve($t),{to:"/notes",class:"hero-button hero-button-primary group"},{default:Wt(()=>[f[4]||(f[4]=Lt(" 进入知识花园 ",-1)),ft(Ve(Ki),{size:16,class:"transition-transform group-hover:translate-x-1"})]),_:1}),ft(Ve($t),{to:"/about",class:"hero-button hero-button-secondary group"},{default:Wt(()=>[f[5]||(f[5]=Lt(" 从这里认识我 ",-1)),ft(Ve(ti),{size:16,class:"transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5"})]),_:1})])]),ie("div",zm,[ft(Dm)]),ie("div",Gm,[a.value?(Xe(),gi(Ve($t),{key:0,to:a.value.path,class:"latest-note group"},{default:Wt(()=>[ie("div",Hm,[f[6]||(f[6]=ie("span",null,[Lt("最新笔记 "),ie("span",{class:"overview-english"},"LATEST NOTE")],-1)),ft(Ve(ti),{size:17,class:"transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5"})]),ie("h2",null,Ye(a.value.title),1),ie("p",Vm,Ye(a.value.description),1),ie("div",km,[ie("time",{datetime:a.value.date},Ye(Ve(Dl)(a.value.date)),9,Wm),ie("span",null,Ye(a.value.readingTime)+" 分钟阅读",1),ie("span",Xm,Ye(a.value.tags.slice(0,2).join(" / ")),1)])]),_:1},8,["to"])):yr("",!0),ie("nav",qm,[(Xe(),rt(It,null,en(l,h=>ft(gs(h.to.startsWith("http")?"a":Ve($t)),{key:h.key,to:h.to.startsWith("http")?void 0:h.to,href:h.to.startsWith("http")?h.to:void 0,target:h.to.startsWith("http")?"_blank":void 0,rel:h.to.startsWith("http")?"noreferrer":void 0,class:"hero-shortcut group"},{default:Wt(()=>[ie("div",Ym,[(Xe(),gi(gs(h.icon),{size:16,"stroke-width":1.5})),ft(Ve(ti),{size:14,class:"shortcut-arrow transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5"})]),ie("div",Km,[ie("span",null,Ye(h.cjk),1),ie("span",Zm,Ye(h.value()),1)])]),_:2},1032,["to","href","target","rel"])),64))])])]),ie("section",$m,[ie("header",Jm,[f[8]||(f[8]=ie("div",null,[ie("p",{class:"eyebrow"},"Recently tendered"),ie("h2",{class:"mt-3 font-serif text-[clamp(1.9rem,4vw,2.8rem)] leading-tight tracking-[-0.04em]"}," 最近打理的笔记 ")],-1)),ft(Ve($t),{to:"/notes",class:"group inline-flex items-center gap-2 text-[0.82rem] text-ember"},{default:Wt(()=>[Lt(" 查看全部 "+Ye(Ve(e).stats.total)+" 篇 ",1),ft(Ve(Ki),{size:14,class:"transition-transform group-hover:translate-x-1"})]),_:1})]),ie("div",Qm,[(Xe(!0),rt(It,null,en(o.value,(h,x)=>ni((Xe(),gi(Ve($t),{key:h.path,to:h.path,class:"group relative flex min-h-[15rem] flex-col overflow-hidden rounded-[8px] border border-line bg-paper p-6 transition-[border-color,box-shadow] duration-500 hover:border-ember/45 hover:shadow-[var(--shadow-md)]"},{default:Wt(()=>[ie("div",jm,[ft(Ul,{status:h.status},null,8,["status"]),ie("span",eg,Ye(Ve(Nl)(h.date)),1)]),ie("h3",tg,Ye(h.title),1),ie("p",ng,Ye(h.description),1),ie("div",ig,[ie("span",rg,Ye(h.tags.slice(0,2).join(" / ")),1),ie("span",sg,[Lt(Ye(h.readingTime)+" MIN ",1),ft(Ve(ti),{size:13,class:"text-ember transition-transform duration-500 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"})])])]),_:2},1032,["to"])),[[u,x*70]])),128)),ni((Xe(),gi(Ve($t),{to:"/notes",class:"group flex min-h-[15rem] flex-col items-start justify-between rounded-[8px] border border-dashed border-line-strong/70 bg-transparent p-6 transition-colors duration-500 hover:border-ember/60"},{default:Wt(()=>[ft(zl,{size:34,class:"opacity-80"}),f[9]||(f[9]=ie("div",null,[ie("h3",{class:"font-serif text-[1.32rem] leading-snug"},[Lt("下一篇笔记"),ie("br"),Lt("会在这里发芽")]),ie("p",{class:"mt-2 text-[0.82rem] text-muted"}," 同步新的 Obsidian 笔记后，这块空地会自动长出内容。 ")],-1)),f[10]||(f[10]=ie("span",{class:"font-mono text-[0.7rem] tracking-[0.14em] text-faint uppercase"}," 等待栽种 → ",-1))]),_:1})),[[u,o.value.length*70]])])]),ie("section",ag,[ni((Xe(),rt("div",og,[ie("div",null,[f[12]||(f[12]=ie("p",{class:"eyebrow"},"Growth stages",-1)),f[13]||(f[13]=ie("h2",{class:"mt-3 font-serif text-[clamp(1.7rem,3.4vw,2.4rem)] leading-tight tracking-[-0.04em]"},[Lt(" 笔记不是归档，"),ie("br"),Lt("而是正在生长的路径。 ")],-1)),f[14]||(f[14]=ie("p",{class:"mt-4 max-w-md text-[0.86rem] leading-relaxed text-muted"}," 每篇笔记都带着成熟度标签与关联关系。你可以按主题筛选，也可以顺着双链一路读下去。 ",-1)),ft(Ve($t),{to:"/notes",class:"mt-6 inline-flex items-center gap-2 rounded-full border border-line bg-paper px-4 py-2.5 text-[0.8rem] transition-colors hover:border-ember/50 hover:text-ember"},{default:Wt(()=>[ft(Ve(Gl),{size:14,class:"text-ember"}),f[11]||(f[11]=Lt(" 打开笔记库索引 ",-1))]),_:1})]),ie("div",lg,[(Xe(!0),rt(It,null,en(c.value,h=>(Xe(),rt("div",{key:h.key,class:"flex flex-col justify-between rounded-[8px] border border-line bg-paper p-4"},[ie("div",null,[ie("span",cg,Ye(h.icon),1),ie("p",ug,Ye(h.label),1),ie("p",dg,Ye(h.hint),1)]),ie("p",{class:"mt-6 font-mono text-[1.6rem] leading-none",style:Ol({color:`var(--${h.tone})`})},Ye(h.count),5)]))),128))])])),[[u]])]),ie("section",fg,[ie("header",hg,[f[16]||(f[16]=ie("div",null,[ie("p",{class:"eyebrow"},"Selected work"),ie("h2",{class:"mt-3 font-serif text-[clamp(1.9rem,4vw,2.8rem)] leading-tight tracking-[-0.04em]"}," 从花园里长出的项目 ")],-1)),ft(Ve($t),{to:"/projects",class:"group inline-flex items-center gap-2 text-[0.82rem] text-ember"},{default:Wt(()=>[f[15]||(f[15]=Lt(" 全部项目 ",-1)),ft(Ve(Ki),{size:14,class:"transition-transform group-hover:translate-x-1"})]),_:1})]),ie("div",pg,[(Xe(!0),rt(It,null,en(Ve(Da),(h,x)=>ni((Xe(),rt("a",{key:h.id,href:h.demo,target:"_blank",rel:"noreferrer",class:"group relative flex min-h-[17rem] flex-col overflow-hidden rounded-[8px] border border-line bg-paper p-6 transition-[border-color,box-shadow,transform] duration-500 hover:-translate-y-1.5 hover:border-ember/45 hover:shadow-[var(--shadow-md)]"},[ie("div",gg,[ie("span",_g,Ye(h.index)+" · "+Ye(h.focus),1),ft(Ve(ti),{size:16,class:"text-faint transition-all duration-500 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-ember"})]),ie("h3",vg,Ye(h.title),1),ie("p",xg,Ye(h.tagline),1),ie("p",Sg,Ye(h.description),1),ie("div",Mg,[(Xe(!0),rt(It,null,en(h.tech.slice(0,3),M=>(Xe(),rt("span",{key:M,class:"rounded-full border border-line px-2 py-0.5 font-mono text-[0.7rem] text-faint"},Ye(M),1))),128))])],8,mg)),[[u,x*90]])),128))])]),ie("section",Eg,[ni((Xe(),rt("div",yg,[(Xe(!0),rt(It,null,en([{label:"Currently",value:Ve(Yi).currently},{label:"Open source",value:Ve(Yi).openSource},{label:"Education",value:Ve(Yi).education}],h=>(Xe(),rt("div",{key:h.label,class:"px-5 py-5"},[ie("p",bg,Ye(h.label),1),ie("p",Tg,Ye(h.value),1)]))),128)),ft(Ve($t),{to:"/about",class:"group flex items-center justify-between gap-3 border-t border-line px-5 py-5 transition-colors hover:bg-ember/8 lg:border-t-0"},{default:Wt(()=>[f[17]||(f[17]=ie("span",{class:"font-serif text-[1.05rem]"},"完整经历",-1)),ft(Ve(ti),{size:16,class:"text-ember transition-transform duration-500 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"})]),_:1})])),[[u]])]),ie("section",Ag,[ie("div",Rg,[(Xe(!0),rt(It,null,en(Ve(Bl).slice(1),(h,x)=>ni((Xe(),gi(Ve($t),{key:h.key,to:h.to,class:"group flex items-center justify-between gap-4 rounded-[8px] border border-line bg-paper px-4 py-3.5 transition-all duration-500 hover:-translate-y-1 hover:border-ember/45"},{default:Wt(()=>[ie("span",null,[ie("span",wg,Ye(h.label),1),ie("span",Cg,Ye(h.hint),1)]),ft(Ve(Ki),{size:15,class:"text-faint transition-all duration-500 group-hover:translate-x-1 group-hover:text-ember"})]),_:2},1032,["to"])),[[u,x*70]])),128))])])])}}}),Fg=oa(Dg,[["__scopeId","data-v-808871ea"]]);export{Fg as default};
