import{_ as a,c as n,o as p,ae as e}from"./chunks/framework.B7Y1jjX-.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"notes/后端/Express.md","filePath":"notes/后端/Express.md"}'),t={name:"notes/后端/Express.md"};function l(i,s,o,c,u,r){return p(),n("div",null,[...s[0]||(s[0]=[e(`<p>封装了Node.js的API，简化了搭建后端的操作流程</p><h4 id="初始化" tabindex="-1">初始化 <a class="header-anchor" href="#初始化" aria-label="Permalink to &quot;初始化&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>npm init //创建package.json文件</span></span>
